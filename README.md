...
This project includes unit tests to validate formatting functions and other logic.
...
```bash
python -m unittest tests/test_update_formatting.py
```
...
Tests are located in the `tests/` directory. Make sure you are running the commands from the project root.
